...
public class WalletAppKit extends AbstractIdleService
{
     ...
     */
    protected BlockStore provideBlockStore(File file)
        ...
        try
        {
            ...
            else
            {
                Futures.addCallback(vPeerGroup.startAsync(), new FutureCallback()
                {
                    ...
                    {
                        final DownloadProgressTracker l = (downloadListener != null) ? downloadListener : new DownloadProgressTracker();
    ...
    protected Wallet createWallet()
    {
        ...
        return (walletFactory != null) ? walletFactory.create(params, kcg) : new Wallet(params, kcg); // default
    }
