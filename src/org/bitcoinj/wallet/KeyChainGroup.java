...
public class KeyChainGroup implements KeyBag
{
    ...
    {
        List<Protos.Key> result = (basic != null) ? basic.serializeToProtobuf() : Lists.newArrayList();
    ...
    {
        checkState(0 < basic.numKeys());
        checkArgument(0 <= keyRotationTimeSecs);
        ...
        checkState(DeterministicSeed.DEFAULT_SEED_ENTROPY_BITS / 8 <= entropy.length);
