...
public abstract class MessageSerializer
{
     ...
     */
    public abstract BitcoinSerializer.BitcoinPacketHeader deserializeHeader(ByteBuffer in)
        throws ProtocolException, IOException, UnsupportedOperationException;
     ...
     */
    public abstract Message deserializePayload(BitcoinSerializer.BitcoinPacketHeader header, ByteBuffer in)
     ...
     */
    public abstract AddressMessage makeAddressMessage(byte[] payloadBytes, int length)
     ...
     * length as block length.
     */
    public final Block makeBlock(byte[] payloadBytes, int length)
        throws ProtocolException
    {
     ...
     * serialization format support.
     */
    public abstract InventoryMessage makeInventoryMessage(byte[] payloadBytes, int length)
        throws ProtocolException, UnsupportedOperationException;
     ...
     * it does not support deserializing transactions.
     */
    public final Transaction makeTransaction(byte[] payloadBytes, int offset)
        throws ProtocolException
    {
        return makeTransaction(payloadBytes, offset, payloadBytes.length, null);
    }

    public abstract void seekPastMagicBytes(ByteBuffer in)
     ...
     * it does not support serializing the given message.
     */
    public abstract void serialize(Message message, OutputStream out)
        throws IOException, UnsupportedOperationException;
}
