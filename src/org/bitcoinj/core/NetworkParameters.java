...
public abstract class NetworkParameters
{
     ...
     */
    public EnumSet<Block.VerifyFlag> getBlockVerificationFlags(final Block block, final VersionTally tally, final Integer height)
    {
        ...
        if (block.isBIP34())
        {
            ...
            if (count != null && getMajorityEnforceBlockUpgrade() <= count)
     ...
     * tests should be a safe subset if block height is unknown.
     */
    public EnumSet<Script.VerifyFlag> getTransactionVerificationFlags(final Block block, final Transaction transaction, final VersionTally tally, final Integer height)
    {
