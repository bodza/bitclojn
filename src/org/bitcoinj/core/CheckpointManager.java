...
public class CheckpointManager
{
    ...
    public CheckpointManager(NetworkParameters params, @Nullable InputStream inputStream)
        throws IOException
    {
    ...
    private Sha256Hash readBinary(InputStream inputStream)
        throws IOException
    {
    ...
    public StoredBlock getCheckpointBefore(long time)
    {
        try
        {
            checkArgument(params.getGenesisBlock().getTimeSeconds() < time);
