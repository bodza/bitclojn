...
public class TransactionOutput extends ChildMessage
{
     ...
     * @throws ProtocolException
     */
    public TransactionOutput(NetworkParameters params, @Nullable Transaction parent, byte[] payload, int offset, MessageSerializer serializer)
        throws ProtocolException
    {
    ...
    public TransactionOutput(NetworkParameters params, @Nullable Transaction parent, Coin value, byte[] scriptBytes)
    {
        ...
        checkArgument(0 <= value.signum() || value.equals(Coin.NEGATIVE_SATOSHI), "Negative values not allowed");
     ...
     */
    @Nullable
    public Address getAddressFromP2PKHScript(NetworkParameters networkParameters)
        throws ScriptException
    {
        return getScriptPubKey().isSentToAddress() ? getScriptPubKey().getToAddress(networkParameters) : null;
    }
     ...
     */
    @Nullable
    public Address getAddressFromP2SH(NetworkParameters networkParameters)
        throws ScriptException
    {
        return getScriptPubKey().isPayToScriptHash() ? getScriptPubKey().getToAddress(networkParameters) : null;
    }
    ...
    */
    ...
    {
        return (parent != null) ? parent.getHash() : null;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return (value == other.value && (parent == null || (parent == other.parent && getIndex() == other.getIndex())) && Arrays.equals(scriptBytes, other.scriptBytes));
    }
