...
public class Peer extends PeerSocketHandler
{
    ...
    @GuardedBy("lastPingTimesLock") private long[] lastPingTimes;
    ...
    public ListenableFuture<List<Transaction>> downloadDependencies(Transaction tx)
    {
        ...
        final ListenableFuture<Object> future = downloadDependenciesInternal(vDownloadTxDependencyDepth, 0, tx, new Object(), results);
    ...
    protected ListenableFuture<Object> downloadDependenciesInternal(final int maxDepth, final int depth, final Transaction tx, final Object marker, final List<Transaction> results)
    {
    ...
    protected void processInv(InventoryMessage inv)
    {
        ...
        try
        {
            if (0 < blocks.size() && downloadData && blockChain != null)
            {
    ...
    public void setDownloadParameters(long secondsSinceEpoch, boolean useFilteredBlocks)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (blockChain != null && blockChain.getChainHead().getHeader().getTimeSeconds() < fastCatchupTimeSecs)
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash)
    {
        ...
        for (int i = 100; cursor != null && 0 < i; i--)
        {
    ...
    public long getLastPingTime()
    {
        ...
        try
        {
            return (lastPingTimes != null) ? lastPingTimes[lastPingTimes.length - 1] : Long.MAX_VALUE;
        }
        finally
        {
            lastPingTimesLock.unlock();
    ...
    public int getPeerBlockHeightDifference()
    {
        ...
        checkState(params.allowEmptyPeerChain() || 0 < chainHeight, "Connected to peer with zero/negative chain height", chainHeight);
