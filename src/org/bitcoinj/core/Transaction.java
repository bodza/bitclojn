...
public class Transaction extends ChildMessage
{
    ...
    public static final Comparator<Transaction> SORT_TX_BY_HEIGHT = new Comparator<Transaction>()
    {
        ...
        public int compare(final Transaction tx1, final Transaction tx2)
        {
            ...
            final int height1 = (confidence1.getConfidenceType() == ConfidenceType.BUILDING) ? confidence1.getAppearedAtChainHeight() : Block.BLOCK_HEIGHT_UNKNOWN;
            final TransactionConfidence confidence2 = tx2.getConfidence();
            final int height2 = (confidence2.getConfidenceType() == ConfidenceType.BUILDING) ? confidence2.getAppearedAtChainHeight() : Block.BLOCK_HEIGHT_UNKNOWN;
    ...
    public void setBlockAppearance(StoredBlock block, boolean bestChain, int relativityOffset)
    {
        ...
        if (bestChain && (updatedAt == null || updatedAt.getTime() == 0 || blockTime < updatedAt.getTime()))
     ...
     */
    public Coin getValue(TransactionBag wallet)
        throws ScriptException
    {
     ...
     */
    public TransactionInput addSignedInput(TransactionOutPoint prevOut, Script scriptPubKey, ECKey sigKey, SigHash sigHash, boolean anyoneCanPay)
        throws ScriptException
    {
    ...
    {
        checkArgument(Block.BLOCK_HEIGHT_GENESIS <= height);
