...
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection
{
    ...
    @VisibleForTesting protected MessageWriteTarget writeTarget;
    ...
    {
        checkArgument(buff.position() == 0 && BitcoinSerializer.BitcoinPacketHeader.HEADER_LENGTH + 4 <= buff.capacity());
        try
        {
