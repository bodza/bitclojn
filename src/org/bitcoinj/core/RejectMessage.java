...
public class RejectMessage extends Message
{
    ...
    public RejectMessage(NetworkParameters params, byte[] payload)
    ...
    public RejectMessage(NetworkParameters params, RejectCode code, Sha256Hash hash, String message, String reason)
        throws ProtocolException
    {
        super(params);
    ...
    public String toString()
    {
        ...
        return String.format(Locale.US, "Reject: %s %s for reason '%s' (%d)", getRejectedMessage(), (hash != null) ? hash : "", getReasonString(), getReasonCode().code);
    }
