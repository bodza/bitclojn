...
public class BlockChain extends AbstractBlockChain
{
     ...
     */
    public BlockChain(Context params, List<? extends Wallet> wallets, BlockStore blockStore)
        throws BlockStoreException
    {
    ...
    public BlockChain(NetworkParameters params, List<? extends Wallet> wallets, BlockStore blockStore)
        throws BlockStoreException
    {
        ...
        throws BlockStoreException
    {
        ...
        try
        {
            ...
            checkArgument(0 <= height && height <= currentHeight, "Bad height: %s", height);
